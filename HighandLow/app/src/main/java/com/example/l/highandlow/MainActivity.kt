package com.example.l.highandlow
...
class MainActivity : AppCompatActivity() {
    ...
    private fun drawCard(){
        ...
        yourCard = (1..13).random()             // 1~13のrangeから乱数生成
        Log.d(tag,"You:"+yourCard)         // log表示
        when(yourCard){                         // yourCardの値に応じて描画するカードを変える
